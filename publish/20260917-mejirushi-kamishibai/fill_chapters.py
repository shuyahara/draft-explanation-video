...
全 8 シーンをそれぞれ 1 章にする。
  ...
  .venv\\Scripts\\python.exe publish/20260917-mejirushi-kamishibai/fill_chapters.py D:/script-to-video-build/mejirushi-v1
"""
import io
import json
import sys
...
OVERRIDE = {  # 章カードのない S1・S3・S8 を短い見出しで補う
    1: "6年前からあった",
    3: "誰が付けているのか",
    8: "商品は同じ、変わったのは周り",
}
