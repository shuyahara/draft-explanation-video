...
| 2026-09-15 | v4 | JUBUuewqqrQ | **非公開（試写用）** | 16:03（終了カード込み）。試写 FB「前段が長い」→ 台本 v5（S1・S2 を統合、前段 53 秒で最初の章へ。9 シーン・5,124 字）。サムネ **A（暫定）**、字幕 ja、概要欄 description-v2.txt（章 9、v4 timeline）。 |
