...
| v8 | 2Q4FkEjCy6w | 非公開（26:34）→ v9 処理完了後に削除 | 2026-09-06 | build/cynicism-kamishibai-v8。タイトル「なぜ人は冷笑してしまうのか」（副題なし、確定）。ディオゲネスの逸話を削除（S3）、語源と反転の短縮版、婉曲→直接（請求書→代償、安い→楽、嗤う→笑う）、読み 8 語追加（audio_query 突合）。概要欄 description-v6.txt（章 8 件）、サムネ C、字幕 ja |
| v9 | UWZlNvHcMcw | **非公開・試写用（26:56、挨拶クリップ込み、サムネ K）** | 2026-09-06 | build/cynicism-kamishibai-v9。試写指摘②: 対比軸「実践して変える／実践する人を笑う」、S6 図解のずれ、S8 の問い、S9「冷たい」の理由・「挑戦者」、字幕見切れ対策（52 字超 11 件を分割）、S13 に写真。概要欄 description-v7.txt |
