...
| v9 | UWZlNvHcMcw | 非公開（26:56）→ v10 処理完了後に削除 | 2026-09-06 | build/cynicism-kamishibai-v9。試写指摘②: 対比軸「実践して変える／実践する人を笑う」、S6 図解のずれ、S8 の問い、S9「冷たい」の理由・「挑戦者」、字幕見切れ対策（52 字超 11 件を分割）、S13 に写真。概要欄 description-v7.txt |
| v10 | dret3F7jPek | **非公開・試写用（26:56、挨拶クリップ込み、サムネ K）** | 2026-09-06 | build/cynicism-kamishibai-v10。テロップだけの板（10 秒超）15 か所を写真＋テロップ／言葉＋ピクトグラムに置換（ユーザー提案→規約化）。台本は v9 と同じ。概要欄 description-v7.txt |
