...
| v4 | v-8HlXEvNOE | **非公開・処理完了・試写用（31:10）** | 2026-09-05 | build/cynicism-kamishibai-v4。v3 ＋ 「無力感→ムリョクカン」（VOICEVOX 辞書 priority 10、tts.py 修正）。ASR で読みを確認済み。概要欄 description-v3.txt（章 8 件）、サムネ C、字幕 ja |
