...
| v8 | 2Q4FkEjCy6w | **非公開・処理完了・試写用（26:34、挨拶クリップ込み）。サムネを K（口元アップ、Codex 生成）に差し替え 2026-09-06** | 2026-09-06 | build/cynicism-kamishibai-v8。タイトル「なぜ人は冷笑してしまうのか」（副題なし、確定）。ディオゲネスの逸話を削除（S3）、語源と反転の短縮版、婉曲→直接（請求書→代償、安い→楽、嗤う→笑う）、読み 8 語追加（audio_query 突合）。概要欄 description-v6.txt（章 8 件）、サムネ C、字幕 ja |
