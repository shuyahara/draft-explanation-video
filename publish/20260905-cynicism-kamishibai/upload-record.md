...
| v7 | 3vUa1L0lUss | **削除済み（2026-09-06、v8 処理完了後）** | 2026-09-06 | build/cynicism-kamishibai-v7。試写指摘の反映（なんのためか・大王の前振り・本文を見てなかった・「嗤」全活用形の読み・結びを決め文で・ジジェク削除）、sketch 図解 17 か所（拡大修正 05e29b2 済み）、chain 2 か所を置換、末尾に endcard.mp4 を結合（--end-card）。v6 は sketch が小さかったため未アップロード。概要欄 description-v5.txt、サムネ C、字幕 ja |
| v8 | 2Q4FkEjCy6w | **削除済み（2026-09-06、v9 処理完了後）** | 2026-09-06 | build/cynicism-kamishibai-v8。タイトル「なぜ人は冷笑してしまうのか」（副題なし、確定）。ディオゲネスの逸話を削除（S3）、語源と反転の短縮版、婉曲→直接（請求書→代償、安い→楽、嗤う→笑う）、読み 8 語追加（audio_query 突合）。概要欄 description-v6.txt（章 8 件）、サムネ C、字幕 ja |
| v9 | UWZlNvHcMcw | **削除済み（2026-09-06、v10 処理完了後）** | 2026-09-06 | build/cynicism-kamishibai-v9。試写指摘②: 対比軸「実践して変える／実践する人を笑う」、S6 図解のずれ、S8 の問い、S9「冷たい」の理由・「挑戦者」、字幕見切れ対策（52 字超 11 件を分割）、S13 に写真。概要欄 description-v7.txt |
| v10 | dret3F7jPek | **公開（2026-09-06）。26:56、挨拶クリップ込み、サムネ K** | 2026-09-06 | build/cynicism-kamishibai-v10。テロップだけの板（10 秒超）15 か所を写真＋テロップ／言葉＋ピクトグラムに置換（ユーザー提案→規約化）。台本は v9 と同じ。概要欄 description-v7.txt |
