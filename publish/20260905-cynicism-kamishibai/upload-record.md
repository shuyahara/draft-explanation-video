...
| v10 | dret3F7jPek | **非公開・処理完了・試写用（26:56、挨拶クリップ込み、サムネ K）** | 2026-09-06 | build/cynicism-kamishibai-v10。テロップだけの板（10 秒超）15 か所を写真＋テロップ／言葉＋ピクトグラムに置換（ユーザー提案→規約化）。台本は v9 と同じ。概要欄 description-v7.txt |
