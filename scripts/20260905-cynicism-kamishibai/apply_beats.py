...
CREDIT = {
    ...
    "lamp": "Photo: Pexels",
    "jar": "Photo: Pexels",
    "alexander": "Photo: Pexels",
    "dog": "Photo: Pexels",
    "delphi": "Photo: Pixabay",
    "waterhouse": "John William Waterhouse, Diogenes (1882), Art Gallery of NSW / Public Domain",
    "dictionary": "Photo: Pexels",
    "office": "Photo: Pexels",
    "fundraiser": "Photo: Pexels",
    "meeting": "Photo: Pexels",
    "election": "Photo: Pixabay",
    "aesop": "Milo Winter, The Aesop for Children (1919) / Public Domain",
    "veg": "Photo: Pexels",
    "lab": "Photo: Pexels",
    "lab2": "Photo: Pexels",
    "bulletin": "Photo: Pexels",
    "poppy": "Photo: Pexels",
    "beach": "Photo: Pexels",
    "exam": "Photo: Pexels",
    "payslip": "Photo: Pexels",
    "chair": "Photo: Pexels",
    "outside": "Photo: Pexels",
    "tv": "Photo: Pexels",
    "angry": "Photo: Pexels",
    "diet": "Photo: Pixabay",
    "report": "Photo: Pexels",
...
BEATS = {
    1: [
        ...
        board("その、うまく言えない笑い", "【定義】写真をはずし、黒板に冷笑の定義を書く",
              telop="冷笑＝本気を、一段高いところから鼻で笑って済ませる態度"),
    ],
    2: [
        board(None, "【冷笑系】写真なし。二人だけで言葉の来歴に入る"),
        img("この言葉のもとになったのは", 1, "agora", "【古代ギリシャ】アテナイの遺跡へ切り替え"),
    ...
    3: [
        ...
        img("人々は彼を、犬と呼んだの", 5, "dog", "【犬】遺跡にいる犬"),
        img("もうひとつ逸話があるわ", 6, "delphi", "【神託】デルフォイの遺跡"),
        board("ただ、ひとつだけ確かなことがあるわ", "【決め文】写真をはずし、語源を黒板に",
              telop="犬（キュオーン）→ シニシズム"),
    ],
    4: [
        ...
        img("英語のシニックが、哲学の一派ではなく", 2, "dictionary", "【19世紀の語義】古い辞書のページ（文字は読めない）"),
        board("ドイツの哲学者ペーター・スローターダイク", "【綴りの違い】写真をはずし、二つの綴りを黒板に",
              telop="Kynismus（古代）／ Zynismus（近代）"),
        img("動かないほうが、傷つかないからよ", 3, "office", "【知った上で動かない】オフィスでスマホを見る手元。白い光"),
        board("犬は、権力に吠えていたのよ", "【決め文】写真をはずし、二人だけで反転を聞かせる",
              telop="犬は権力に吠え、冷笑は本気に吠える"),
    ],
    5: [
        chapter(),
        img(None, 1, "fundraiser", "【募金の横を通り過ぎる】街頭の呼びかけを見ずに通る人々",
            telop="津田正太郎（慶應義塾大学）現代ビジネス"),
        board("「あの人はカネのためにやっている」", "【動機を疑う】写真をはずし、三つの決めつけを黒板に", telop="「カネのため」「売名だ」「ポーズだ」→ 中身を吟味する手間が省ける"),
    ...
    6: [
        ...
        board("ずんだもんと同じ答えの人が", "【数字】写真をはずし、割合を黒板に",
              telop="「皮肉屋の方が賢い」と答えた人 56〜70%（米・独・英）"),
        board("そしてこの見え方の利益は", "【決め文】第二の安さ", telop="第二の安さ：何もしなくても賢い側に立てる"),
    ],
    7: [
        chapter(),
        diagram(None, "【図解: 三つの安さ】前章の二つに三つ目が加わり「冷笑は安い」へ収束する（構造が主張）",
                {"type": "narrative", "layout": "converge",
                 ...
                 "result": {"text": "冷笑は安い", "at": "だとすれば、冷笑は"}}),
        img("日本財団が2019年に行った", 1, "election", "【日本の若者】選挙ポスター掲示板の前を通る人々",
            telop="「自分で国や社会を変えられる」日本 18.3%（9カ国中最下位）"),
        board("この前提に立つと", "【前提】写真をはずし、前提を黒板に", telop="「どうせ変わらない」→ 変えようとする人が愚か者に見える"),
        img("哲学者のヤン・エルスターが", 2, "aesop", "【酸っぱい葡萄】ナレーション自身の比喩を PD 挿絵で"),
        board("変えられない社会なら", "【決め文】写真をはずし、狐と冷笑を重ねる"),
    ],
    8: [
        ...
        diagram("47パーセントの人が", "【図解: 善行者への貶め】道徳的な相手→責められる予期→貶める、の一本鎖",
                {"type": "narrative", "layout": "chain",
                 "items": [
                     ...
                     {"id": "expect", "text": "責められる予期", "icon": "psychology_alt", "at": "そして、否定が強い人ほど"},
                     {"id": "derog", "text": "相手を貶める", "icon": "thumb_down", "at": "「そう思われるだろう」と予期しただけで", "after": "予期しただけで"},
                 ],
                 "caption": {"at": "研究チームはこれを", "text": "善行者への貶め"}}),
        img("さらに2008年の実験では", 2, "lab", "【2008年の実験】実験室で課題に向かう参加者の後ろ姿",
            telop="Monin, Sawyer & Marquez (2008) JPSP"),
        img("ここで、冒頭の画面に戻って", 3, "train", "【冒頭の再演】電車のスマホ画面を再掲"),
        board("この実験で標的になったのは", "【決め文】写真をはずし、二人だけで"),
    ],
    9: [
        ...
        board("そこは、付け加えておかなければ", "【留保】予測したのは憤り", telop="転落を喜ぶ気持ちを予測したのは「不当だ」という憤り"),
    ],
    10: [
        board(None, "【二つの軸】写真なし。温かさ×有能さを言葉で", telop="Fiske, Cuddy, Glick & Xu (2002) JPSP"),
        img("一方で、本気で何かを変えようとする人は", 1, "beach", "【ボランティア】海岸清掃の人々（遠景）。冒頭の投稿の中身"),
    ...
    11: [
        ...
        board("だけど、安いものはたいてい", "【決め文3】", telop="安いものは、後で高くつく"),
    ],
    12: [
        img(None, 1, "tv", "【勝ち負けの報道】テレビスタジオ", telop="Cappella & Jamieson (1997) Spiral of Cynicism"),
        board("のちに32の研究", "【メタ分析】写真をはずし、数字を黒板に",
              telop="戦略報道 → シニシズム（メタ分析 2021・32研究・約3万9000人）"),
        img("SNSには、別の経路があるの", 2, "angry", "【攻撃投稿と怒り】スマホを握る手元",
        ...
        board("そして、この無力感には歴史があるの", "【三無主義】年表を黒板に",
    ...
    14: [
        ...
        img("さっきの画面を、もう一度", 2, "train", "【冒頭へ回帰】電車のスマホ画面を再掲"),
