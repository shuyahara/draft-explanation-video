...
BEATS = {
    ...
    3: [
        ...
        board("それでも、この犬という呼び名が", "【決め文】写真をはずし、語源を黒板に",
              telop="犬（キュオーン）→ シニシズム"),
    ],
    4: [
        ...
        img("動かないほうが、傷つかずに済むからよ", 3, "office", "【知った上で動かない】オフィスでスマホを見る手元。白い光"),
    ...
    7: [
        ...
        board("社会なんて変えられない、と思うなら", "【決め文】写真をはずし、狐と冷笑を重ねる"),
    ],
    8: [
    ...
    9: [
        ...
        board("ただ、ここは少し違いがあるの", "【留保】予測したのは憤り", telop="転落を喜ぶ気持ちを予測したのは「不当だ」という憤り"),
    ],
    10: [
    ...
    12: [
        ...
        board("32の研究と", "【メタ分析】写真をはずし、数字を黒板に",
        ...
        board("この無力感には、歴史もあるの", "【三無主義】年表を黒板に",
