...
BEATS = {
    ...
    3: [
        ...
        diagram("昔のシニシズムは、富や権力を", "【対比: 昔と今】笑う対象の違いを左右 2 列で見せる（ずんだもんの「下から上？」への答え）",
                sketch([[cell("old", "昔のシニシズム", "account_balance", at="昔のシニシズムは、富や権力を"),
                         cell("old_t", "持つ側を笑う", "sentiment_dissatisfied", at="昔のシニシズムは、富や権力を", after="人々を笑った")],
                        [cell("now", "今の冷笑", "smartphone", at="今の冷笑は、自分から行動する"),
                         cell("now_t", "行動する側を笑う", "directions_run", at="今の冷笑は、自分から行動する", after="人々を笑うの")]],
                       arrows=[("old", "old_t"), ("now", "now_t")],
                       caption={"text": "笑う相手が、権力から本気へ", "at": "笑う相手が、権力から、本気へ"})),
    ],
    4: [
        chapter(),
    ...
    6: [
        ...
        diagram(None, "【図解: 楽な理由三つ】前章の二つに三つ目が加わり「冷笑は楽」へ収束する（構造が主張）",
                {"type": "narrative", "layout": "converge",
                 ...
                 "result": {"text": "冷笑は楽", "at": "つまり冷笑は、何かから"}}),
