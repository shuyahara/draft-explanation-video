...
BEATS = {
    ...
    4: [
        ...
        diagram("批判する側も、擁護する側も", "【対比: 敵同士が同じことをする】両側から中央の決めつけへ矢印",
                sketch([[cell("a", "批判する側", "person", at="批判する側も、擁護する側も", after="批判する側"),
                       ...
                       arrows=[("a", "m"), ("b", "m")])),
        board("冷笑が楽な理由の一つ目は", "【決め文】黒板に一つ目", telop="楽な理由①：考えなくて済む"),
    ],
    5: [
        ...
        diagram("同じ質問を、オランダの", "【実験: 674 人の答え】質問 → 多数派の答えと割合",
                sketch([[cell("q", "674人に質問", "groups", at="あわせて674人にね", after="674人"),
                       ...
                       arrows=[("q", "a")])),
        board("しかも、その「賢そう」という印象は", "【決め文】第二の安さ", telop="楽な理由②：何もしなくても賢い側に立てる"),
    ...
    6: [
        ...
        board("つまり冷笑は、何かから", "【守っているものは三つ】収束図をはずし、板に問いだけ", telop="冷笑が守っているものは、三つ"),
    ...
    10: [
        ...
        board("でも、楽な分だけ", "【決め文2】", telop="楽な分だけ、後で代償を払う"),
    ],
    11: [
        chapter(),
    ...
    13: [
        ...
        board("何も失わない場所から笑っていると", "【削られるもの】写真をはずし、二人だけで"),
