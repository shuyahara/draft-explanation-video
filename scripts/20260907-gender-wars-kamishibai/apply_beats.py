...
CREDIT = {
    # 生成イラスト（Codex 経由。2026-09-08「主要場面は生成イラストで直接描く」）
    "ill_argue": "Illustration: AI generated",
    "ill_storm": "Illustration: AI generated",
    "ill_hesitate": "Illustration: AI generated",
    "ill_typing": "Illustration: AI generated",
    "ill_theyall": "Illustration: AI generated",
    "ill_ranked_feed": "Illustration: AI generated",
    "ill_two_reactions": "Illustration: AI generated",
    "ill_manager": "Illustration: AI generated",
    "ill_ad_feed": "Illustration: AI generated",
...
SOURCE_FILE = {
    "ill_argue": "illust/ill_argue.png",
    "ill_storm": "illust/ill_storm.png",
    "ill_hesitate": "illust/ill_hesitate.png",
    "ill_typing": "illust/ill_typing.png",
    "ill_theyall": "illust/ill_theyall.png",
    "ill_ranked_feed": "illust/ill_ranked_feed.png",
    "ill_two_reactions": "illust/ill_two_reactions.png",
    "ill_manager": "illust/ill_manager.png",
    "ill_ad_feed": "illust/ill_ad_feed.png",
...
PAUSE_OVERRIDES: dict[int, list[tuple[str, float]]] = {
    3: [("と考えてもらえばいいわ", 0.5)],
    4: [("その6.7倍だったわ", 0.6)],
    5: [("はっきりした関連が出なかったのよ", 0.7), ("だけじゃない、ということなの", 0.5)],
    6: [("そう、だから男女論は炎上しやすいのよ", 0.8)],
    7: [("6割から7割が正義感だったの", 0.6)],
    8: [("悪に負けることになってしまうの", 0.6)],
    10: [("結果は逆だったのよ", 0.8)],
    11: [("だから、他の話題より燃えやすいのだ", 0.8), ("あの画面の激しさだけでは判断できないわ", 0.7), ("問題まで消えるわけじゃないの", 1.0), ("関心まで失わないでほしいの", 0.8)],
}
...
BEATS = {
    1: [
        ...
        img("激しい言葉でお互いを責め合ってた", 2, "ill_argue", "【燃えている投稿】夜の寝室、スマホの中で男女の陣営が吹き出しで応酬（生成イラスト。文字はなぐり書き）"),
        img("怒りのコメントが何百件も", 3, "ill_storm", "【何百件】一つの投稿に怒りの返信が嵐のように積み上がる（生成イラスト）"),
    ...
    3: [
        ...
        board("怒りを書き込みやすくする仕組みが三つある",
              ...
              telop="ネットで怒りを投稿しやすい理由\n① 目にする回数が増える\n② 書く負担が減る\n③ 反応が大きく返る"),
        img("三つ目は、怒って書いたときに", 2, "cmt3", "【手応え】いいねや返信が並ぶ画面へ（文字は読めない）"),
        img("面と向かって「あなたは間違っている」", 3, "ill_hesitate", "【対面】向かい合った席で言い出せずに汗をかく人（生成イラスト）"),
        img("でも画面の向こうになら", 4, "ill_typing", "【画面越し】ソファで軽い顔つきのまま片手で辛辣な投稿を打つ人（生成イラスト）。決め文まで保持"),
        img("今度は、数字で確かめた研究", 5, "form3", "【実証研究へ】研究資料の束。ブレイディの分析の導入（大学の建物は別大学の誤認を招くため v5 で差し替え）",
            ...
            sketch(
                [
                    [
                        ...
                        cell("op", text="怒りの言葉が一つ", icon="search", at="そういう言葉が多い投稿ほど"),
                        cell("res", text="拡散されやすい", icon="trending_up", value="＋約2割", at="だいたい二割くらい高くなるの"),
                    ],
                    [
    ...
    4: [
        ...
        img("敵として見る相手を指す言葉が一つ入ると", 3, "ill_theyall", "【敵として見る相手】線の向こうの顔のない群れを指さす人（生成イラスト）。名指しする言葉が入るとシェアが増える話へ"),
        diagram(
            "同じ研究の中で、怒りや非難の言葉",
            "【比較: 同一研究内】怒り・非難の言葉 →（矢印）→ 相手を名指しする言葉 6.7倍。基準側に 1倍 は書かない",
            sketch(
                [
                    [
                        cell("base", text="怒り・非難の言葉", icon="local_fire_department",
                             at="同じ研究の中で、怒りや非難の言葉"),
                        cell("out", text="相手を名指しする言葉", icon="campaign", value="6.7倍",
                             at="相手を名指しする言葉の効き目は", after="その6.7倍だったわ"),
                    ],
                ],
                arrows=[("base", "out")],
                highlight={"ids": ["out"], "at": "怒りの言葉より、名指しする言葉の方が"},
                caption={"text": "同じ研究の中で比べた効き目", "at": "同じ研究の中で、怒りや非難の言葉"},
            ),
        ),
    ...
    5: [
        ...
        img("その記録を、ニューヨーク大学などの研究チーム", 3, "paper2", "【研究】新聞紙面（別カット）。570万クリックの分析へ（大学の建物は別大学の誤認を招くため v5 で差し替え）",
        ...
        img("反応の多い順の画面には、怒りを表す投稿", 5, "ill_ranked_feed", "【反応順の画面】上に赤く燃える投稿、下に押しやられる穏やかな投稿（生成イラスト）"),
    ...
    6: [
        ...
        img("ここで、さっきの「相手を名指しする言葉」", 2, "type3", "【接続】コメント欄へ。大きな主語の話につなぐ"),
        board("「男は」「女は」という大きな主語が出ると",
              "【覚えてほしい要点】大きな主語が生む二つの受け取られ方を黒板の文字で（番号付き）",
              telop="「男は」「女は」と言われると\n① 責められたと感じる人が出る\n② 代弁されたと感じる人も出る"),
        img("責められたと思った人は言い返して", 3, "ill_two_reactions", "【両方が同時に】一つの投稿を挟んで、傷ついて怒る人と、うなずいてハートを押す人（生成イラスト）"),
        ...
        img("その分析では、同じ型の炎上が", 6, "ad1", "【型の反復】街頭の広告看板を保持して、同じ型が繰り返される話へ（夜の繁華街は主題と合わないため v5 で差し替え）"),
        img("ここまでの研究は、政治の話題で調べたものが多いの", 0, "form3", "【適用範囲の留保】大学の建物。政治の話題で調べた研究が多い、の一言（旧: 板）"),
    ...
    7: [
        ...
        board("書き込む動機は、6割から7割が正義感",
              ...
              telop="書き込んでいる人\n① 6〜7割は正義感\n② 男性が多い\n③ 役職が上の人が多い"),
        img("え、会社で偉い人なのだ", 6, "ill_manager", "【意外な属性】夕方のオフィスで正義感の顔つきで長文を打つ管理職（生成イラスト）"),
    ...
    9: [
        ...
        img("広告で収入を得るサービスでは", 2, "ill_ad_feed", "【仕組み】反応の多い投稿が上へ押し上げられ、横に伸びるグラフと硬貨・広告（生成イラスト）"),
    ...
    10: [
        ...
        diagram(
            "なんとかフェミとか、弱者男性とか",
            "【因果: 呼び名が集団を作って見せる】呼び名→名指しの言葉と同じ→拡散しやすい→一つの集団に見える。決め文まで保持（旧: 板「ネットの呼び名＝…」は説明になっていなかった）",
            {
                "type": "narrative",
                "layout": "chain",
                "items": [
                    {"id": "name", "text": "相手をひとまとめに呼ぶ", "icon": "label", "at": "なんとかフェミとか、弱者男性とか"},
                    {"id": "same", "text": "名指しする言葉と同じ", "icon": "campaign", "at": "相手を名指しする言葉は、拡散を大きく強めていたわね"},
                    {"id": "spread", "text": "拡散しやすくなる", "icon": "trending_up", "at": "呼び名をつけることが、燃えやすくする仕掛けにもなるのだ"},
                    {"id": "group", "text": "一つの集団に見える", "icon": "groups", "at": "そういう呼び名が広まると"},
                ],
                "caption": {"text": "呼び名が集団を作って見せる", "at": "そういう呼び名が広まると"},
            },
        ),
    ],
    11: [
        ...
        diagram(
            "僕の言葉でまとめてみるのだ",
            "【まとめ: 仕組み×話題の性質】左列＝ネットの仕組み（言葉が広がる／反応順の画面）、右列＝男女の話の性質（その言葉が入りやすい／全員が当事者）。4 項目が並列で重なって見えた旧 converge を、2 列に分けて構造を見せる",
            sketch(
                [
                    [
                        cell("h1", text="ネットの仕組み", icon="public", at="僕の言葉でまとめてみるのだ"),
                        cell("h2", text="男女の話の性質", icon="wc", at="僕の言葉でまとめてみるのだ"),
                    ],
                    [
                        cell("a", text="敵の名指しが広がる", at="まず、怒りや否定的な言葉と"),
                        cell("c", text="その言葉が入りやすい", at="「男は」「女は」という言い方が"),
                    ],
                    [
                        cell("b", text="反応順の画面が押す", at="しかも、反応の多い順に並ぶ画面が"),
                        cell("d", text="全員が当事者になる", at="そして男女の話は"),
                    ],
                ],
                arrows=[("h1", "a"), ("a", "b"), ("h2", "c"), ("c", "d")],
                highlight={"ids": ["c", "d"], "at": "だから、他の話題より燃えやすいのだ"},
                caption={"text": "二つが重なるから燃えやすい", "at": "だから、他の話題より燃えやすいのだ"},
            ),
        ),
        img("よくまとまったわね", 3, "phone1", "【受け止め】スマホの別カット。最初の疑問への答えを受け止める"),
        img("反応がつくと、書き続けやすくなるのだ", 2, "type2", "【補足】スマホを見る手元。反応が書き手を後押しする話"),
        img("あなたが見たのは、男の人と女の人が", 4, "ill_argue", "【冒頭の回収】冒頭と同じ、男女の陣営が応酬する画面（生成イラスト）。実際に書いていたのはごく一部だった"),
        img("世の中全体が憎み合っているかどうかは", 0, "crowd1", "【世の中全体】人混みの遠景。画面の激しさだけでは全体は分からない（旧: 板。一文を見出しと本文に分断しているだけで説明になっていない、との指摘）"),
        img("賃金の差や家事の時間の偏りのように", 5, "crowd3", "【残る問題】人混みの遠景。画面の外にいる人たちの問題は男女どちらの側にも残る",
            telop="画面の外の問題は、男女どちらの側にも残る"),
        img("だから、画面の激しさに慣れて", 6, "phone2", "【燃えている投稿を見る手元】画面の激しさに慣れない、の場面（旧: 手洗いの写真は台詞と無関係、との指摘）"),
