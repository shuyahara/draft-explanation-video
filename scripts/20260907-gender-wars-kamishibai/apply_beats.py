...
BEATS = {
    ...
    2: [
        ...
        img("世の中全体が本当に対立しているかどうか", 3, "crowd3", "【断言できない範囲】人混みの別カットに替えて限界の宣言へ"),
    ...
    5: [
        ...
        img("そもそも、何が目の前に並ぶのか", 0, "news2", "【並べる側へ】タブレットでニュースを見る手元。何が目の前に並ぶか、の転換（旧: 板）"),
    ...
    6: [
        ...
        img("ここまでの研究は、政治の話題で調べたものが多い", 0, "univ3", "【適用範囲の留保】大学の建物。政治の話題で調べた研究が多い、の一言（旧: 板）"),
    ...
    10: [
        ...
        img("ただし、勘違いしないでね", 0, "cmt1", "【留保】コメント欄。一つ一つの投稿が正しいという意味ではない（旧: 板）"),
    ...
    11: [
        ...
        img("中高年が悪い、という話でもないの", 0, "f2f2", "【留保】ベンチに座る二人（後ろ姿）。集団の傾向であって個人の評価ではない（旧: 板）"),
