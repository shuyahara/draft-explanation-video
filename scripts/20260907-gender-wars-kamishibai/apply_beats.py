...
BEATS = {
    ...
    7: [
        ...
        img("スイスでは、上位1パーセントの人が", 7, "form2", "【海外②】研究資料の束。スイスのヘイトスピーチ分析（アメリカの街並みだと別の国に見えるため差し替え）",
    ...
    8: [
        ...
        img("そして、引きにくさを強めるものが", 4, "form3", "【もう一つの力】研究資料の束。イェールの研究へ（大学の建物は S3 と同じ写真になり別大学の誤認を招くため差し替え）",
    ...
    10: [
        ...
        img("見え方が作られていても、怒りのもとまで", 8, "crowd3", "【決め文】人混みの遠景（ブレ）。現実に生きている人たちの画で保持。間 2.5 秒"),
    ],
    11: [
    ...
    12: [
        ...
        diagram(
            ...
            "【収束: 今日の答え】ずんだもんのまとめに同期して 1 項目ずつ出し、最後に結論へ収束させる",
            {
                ...
                "layout": "converge",
                "items": [
                    {"id": "word", "text": "広がる言葉", "at": "まず、道徳や感情に触れる言葉や"},  # ビート開始と同時に出さないと黒板が空になる（レンダ v1 の 22:30）
