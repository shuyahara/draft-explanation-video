...
図解 10 箇所（型・layout の重複は各 2 回まで、隣接する図解ビートに同じ layout を置かない）:
  ...
  S10 sketch 1行3列（日本の男女の差の数字 3 つ。残り 3 つは写真のテロップ）
  S11 sketch 2列3行（画面で見える日本と調査が見た日本）
  S12 narrative converge（今日の答えへの収束）
...
BEATS = {
    1: [
        ...
        img("気づいたら一時間", 4, "bed2", "【一時間】暗い部屋の別カットに戻して、やめられなかった時間へ"),
        img("おごるか割り勘か", 5, "bill1", "【入り口】伝票と財布。日常のどこにでも入り口がある話へ"),
        img("僕、だんだん分からなくなってきた", 6, "phone1", "【疑問】スマホを見る手元に替えて、ずんだもんの引っかかりへ"),
        img("そこに引っかかったのは", 7, "phone2", "【肯定】スマホの別カットに替えて「その感覚は的外れじゃない」へ"),
        board("ああいう炎上に書き込んでいる人は",
              "【予告】この動画で示す数字を先に一つだけ出す（総合レビューの冒頭フック提案）",
              telop="炎上に書き込んでいる人\n＝ 二百人に一人ほど"),
        img("まずは、何を「炎上」と呼ぶ", 8, "news1", "【定義へ】ニュースサイトを見る手元。次章の言葉そろえへ"),
    ],
    2: [
        board(None, "【主題の定義】この動画で言う「炎上」を黒板の文字で",
              telop="「炎上」とは\n短い間に批判や非難がどっと集まり\nまとめサイトやニュースにまで広がること"),
        img("昨日見たやつは、まさにそれ", 1, "news2", "【当てはめ】ニュースサイトの別カットで、昨日見たものと重ねる"),
        board("答えを急ぐより、三つに分けて",
              "【この動画で確かめること】三つの問いを黒板の文字で（番号付き）",
              telop="今日確かめる三つのこと\n① 何があの激しさを作るのか\n② 実際に書いているのは誰か\n③ なぜ世の中全体の声に見えるのか"),
        img("「本当に憎み合ってるか」を、そのまま調べる", 2, "crowd1", "【直接は測れない】人混みの遠景へ。世の中全体は直接測れない話"),
        img("世の中全体が本当に対立しているかどうか", 3, "crowd2", "【断言できない範囲】人混みの別カットに替えて限界の宣言へ"),
        board("でも、あの激しさが誰の声でできているかなら",
              "【決め文】答えられる問いの範囲を黒板の文字で。間 1.5 秒を保持",
              telop="断言できないこと：対立が本物かどうか\n数えられること：あの激しさが誰の声でできているか"),
        img("じゃあ、最初の疑問なのだ", 4, "phone3", "【次章へ】スマホの別カットで「怒った投稿ばかり広がる」の問いへ"),
    ],
    3: [
        chapter(),
        img(None, 1, "hall1", "【心理学の導入】無人の大講義室。クロケットの枠組みへ",
            telop="Crockett (2017) Nat Hum Behav"),
        board("ネットには、怒りを書き込みやすくする仕組みが三つある",
              "【鍵になる整理】三つの仕組みを黒板の文字で（番号付き）",
              telop="ネットが怒りを書き込みやすくする三つの仕組み\n① 怒るきっかけを見る回数が増える\n② 怒りを表に出す負担が減る\n③ いいねや返信が大きく返ってくる"),
        ...
        img("ただ、これは投稿を集めて比べた分析", 6, "paper1", "【留保】新聞紙面へ。観察であって実験ではない、の一言"),
    ],
    4: [
        img(None, 1, "type2", "【転換】スマホに文字を打つ指先（別カット）。もっと広がる言葉の予告"),
        board("相手をひとまとめにして",
              "【鍵になる用語】相手を名指しする言葉の定義を黒板の文字で",
              telop="相手を名指しする言葉\n＝ 相手をひとまとめにして「あいつら」と呼ぶ言葉"),
        ...
        board("ここは注意してね",
              "【混同を防ぐ】67％と6.7倍が別の比較であることを黒板の文字で（レビューの最優先指摘）",
    ...
    5: [
        ...
        img("あるニュースサイトが実際にやっていた", 2, "paper3", "【比べ方】紙面の別カットで、見出しを二通り用意する話へ"),
        ...
        board("そもそも、何が目の前に並ぶのか",
              "【論の区切り】自分で開くかの話から、並べる側の話へ（総合レビューの転換明示の指摘）",
              telop="ここまで＝自分で何を開くか\nここから＝そもそも何が目の前に並ぶか"),
        img("それを調べたのが、コーネル・テック", 4, "srv1", "【並べる側】サーバー室の機械。監査研究の導入",
        ...
        img("でも、めたん", 8, "crowd2", "【次章への問い】人混みの遠景。政治・宗教でも同じ仕組みのはず、の問いへ"),
    ],
    6: [
        chapter(),
        ...
        img("たとえば、男は仕事、女は家事", 5, "sink2", "【役割の描き方】流し台の手元。役割分担の描かれ方へ"),
        img("その分析では、同じ型の炎上が", 6, "ad2", "【型の反復】広告看板の別カットで、同じ型が繰り返される話へ"),
        board("ここまでの研究は、政治の話題で調べたものが多い",
              "【論の区切り】ここまでの研究の適用範囲を黒板の文字で（類推であることの明示）",
              telop="ここまでの研究は政治の話題が対象\n＝ 男女の話で同じ数字が出たわけではない\n＝ 同じ仕組みが働きうる、ということ"),
        img("あの言い争いを実際に書いてるのは", 7, "phone1", "【次章へ】スマホを見る手元。書いている人への問いへ"),
    ],
    7: [
        chapter(),
        ...
        diagram(
            "アメリカでは、国の政治についての投稿",
            "【割合: 発信の集中】人型 10 個のうち 1 つだけが点灯し、残りは沈む",
            {
                "type": "narrative",
                "layout": "row",
                "count": 10,
                "icon": "person",
                "select": {"at": "アメリカでは、国の政治についての投稿", "lit": [1]},
                "caption": {"text": "上位一割が投稿の97％", "at": "アメリカでは、国の政治についての投稿"},
            },
        ),
        img("スイスでは、上位1パーセントの人が", 7, "us2", "【海外②】アメリカの街並み（別カット）。スイスのヘイトスピーチ分析",
            telop="Gennaro et al. (2025)：上位1％が46％"),
    ...
    9: [
        ...
        img("少ない人の声が、繰り返し目立つ場所に", 3, "crowd2", "【押し上げ】人混みの遠景。少ない声が繰り返し目立つ場所に出てくる"),
        ...
        img("それに私たちは、相手側を実際より過激に", 5, "ans1", "【認識のずれ】アンケートに答える手元。モア・イン・コモンの調査へ",
            telop="More in Common (2019)：米国が対象"),
        img("人々は、対立する側のおよそ55パーセント", 6, "us1", "【思っていた割合】アメリカの街並み。相手の55％が過激だと思われていた"),
        img("実際に過激な意見を持っていたのは", 7, "ans2", "【比較】アンケートの別カットに、二つの数字を並べたテロップを重ねる",
            telop="思っていた＝相手の55％が過激／実際＝30％"),
        img("これはアメリカの政治の対立を", 8, "us2", "【留保】アメリカの街並み（別カット）。日本の男女論の数字ではない、の一言"),
        img("少数の声でも、実際の人数よりずっと大きく", 9, "crowd3", "【決め文】人混みの遠景で保持。間 2.0 秒"),
    ],
    10: [
        chapter(),
        board(None, "【論の区切り】ここまで作られていたのは何か、まだ調べていないのは何かを黒板の文字で",
              telop="ここまでの仕組みが作るのは、主に見え方\n怒りのもとになる問題があるかは、まだ調べていない"),
        img("今日見てきたのは", 1, "phone2", "【振り返り】スマホを見る手元。仕組みの話だけしてきた確認"),
        img("仕組みの話だけしてたのだ", 2, "phone3", "【気づき】スマホの別カット。中身を数字で見る、への転換"),
        board("ジェンダーギャップ指数という指標があるわ",
              "【鍵になる用語】ジェンダーギャップ指数が何を測っているかを黒板の文字で",
              telop="ジェンダーギャップ指数\n＝ 教育・経済・政治などの男女の差を順位にした指標"),
        diagram(
            "2024年、日本は146カ国中118位だったの",
            "【数字: 日本の男女の差】三つの数字を 1 行 3 列で。発話に同期して 1 つずつ出す",
            sketch(
                [
                    [
                        cell("rank", text="146カ国中", icon="public", value="118位", at="2024年、日本は146カ国中118位だったの"),
                        cell("wage", text="男性100に対し", icon="payments", value="75.8", at="2024年の賃金は、男性を100としたとき"),
                        cell("home", text="家事・育児の時間", icon="home", value="約4倍", at="総務省の調査だと、家事や育児にあてる時間は"),
                    ],
                ],
                caption={"text": "日本の男女の差を測った統計", "at": "2024年、日本は146カ国中118位だったの"},
            ),
        ),
        img("2018年には、東京医科大学の入試で", 3, "exam1", "【入試】無人の試験会場の机",
            telop="2018年 東京医科大学：合格率は男子が女子の約3倍"),
        img("文部科学省が81の大学を調べたところ", 4, "exam2", "【緊急調査】試験会場の別カット。10校で不適切な扱いが認められた話へ",
            telop="文部科学省の調査：81大学中10校で不適切"),
        img("内閣府の調査では、無理やりに性交等", 5, "crowd1", "【性暴力】人混みの遠景（顔は判別できない）",
            telop="内閣府の調査：女性のおよそ14人に1人"),
        img("男性の被害は、見えにくいことが多いの", 6, "train1", "【男性側】満員電車のホーム（顔は判別できない）",
            telop="東京都の調査：被害を答えた男性8.5％"),
        img("しかも、誰にも相談しなかった割合は", 7, "train2", "【相談しにくさ】ホームの別カット。記録に出てきにくい話へ"),
        board("ただし、勘違いしないでね",
              "【論の区切り】この章が示したことと、示していないことを黒板の文字で",
              telop="示したのは、背景となる問題が実在すること\n＝ 一つ一つの投稿が正しい、という意味ではない"),
        img("見え方が作られていても、怒りのもとまで", 8, "coin1", "【決め文】硬貨と紙幣。画面の外に残る問題の画で保持。間 2.5 秒"),
    ],
    11: [
        ...
        diagram(
            ...
            sketch(
                [
                    ...
                    [
                        cell("l3", text="若い人ほど過激", icon="person", at="じゃあ、意見が両極に見えていたのは、どの層なのだ"),
        ...
        board("中高年が悪い、という話でもないの",
              "【論の区切り】この調査から言えないことを黒板の文字で（番号付き）",
              telop="この調査で言えないこと\n① 一つの調査であり、男女論を測ったものではない\n② 集団の傾向であって、一人ひとりの評価ではない"),
        img("ここまでの話とつなげると", 5, "crowd2", "【整理】人混みの遠景。全体と目立つ場所の違いへ"),
    ...
    12: [
        ...
        diagram(
            "まず、道徳や感情に触れる言葉や",
            "【収束: 今日の答え】ずんだもんのまとめに同期して 1 項目ずつ出し、最後に結論へ収束させる",
            {
                "type": "narrative",
                "layout": "converge",
                "items": [
                    {"id": "word", "text": "広がる言葉", "at": "そういう言葉が入った投稿は、広がりやすいのだ"},
                    {"id": "order", "text": "反応順の画面", "at": "しかも、反応の多い順に並ぶ画面では"},
                    {"id": "party", "text": "全員が近い話題", "at": "男女の話は、多くの人が自分に関わる話として受け取るのだ"},
                    {"id": "few", "text": "書くのは0.5％", "at": "だから「男は」「女は」と言われるたび"},
                ],
        ...
        board("世の中全体が憎み合っているかどうかは",
              ...
              telop="画面の激しさだけでは\n世の中全体が憎み合っているかは判断できない"),
        img("賃金の差も、家事の時間も", 5, "coin2", "【残る問題】硬貨と紙幣（別カット）。画面の外に残るもの",
            telop="賃金の差・家事の時間・入試の点数は、画面の外に残る"),
        img("だから、画面の激しさに慣れて", 6, "sink1", "【関心を失わない】流し台の手元。現実の問題の画へ"),
        img("……でも、今夜も指が止まらなくなったら", 7, "bed2", "【回帰】暗い部屋の別カット。冒頭の「指が止まらない」を回収"),
        img("声の大きさは、正しさでもないし", 8, "close1", "【最後の一枚】暗い部屋でスマホを伏せて置く手。アウトロで保持。間 2.5 秒"),
    ],
}
