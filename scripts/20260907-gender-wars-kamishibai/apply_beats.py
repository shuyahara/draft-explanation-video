...
図解 9 箇所（型・layout の重複は各 2 回まで、隣接する図解ビートに同じ layout を置かない）:
  ...
  S11 sketch 2列2行（画面で見える日本と調査が見た日本）
...
BEATS = {
    ...
    6: [
        ...
        img("それと、これは私の推論だけど", 0, "type1", "【推論】スマホに文字を打つ指先。不満から書かれる投稿には否定的な言葉が入りやすい、の推論"),
