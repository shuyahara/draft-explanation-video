...
BEATS = {
    ...
    2: [
        ...
        img("ドパガキって言葉も", 3, "stairs", "【デトックス】スマホを引き出しにしまう手"),
        board("ただ、この説明には", "【決め文】写真をはずして間。反転の一撃", telop="ドーパミン ≠ 快楽物質"),
    ],
    3: [
        chapter(),
        img(None, 1, "lab", "【1997年の実験】脳波キャップを付けた被験者の後ろ姿（脳の実験と一目で分かる絵）", telop="Schultz et al., Science (1997)"),
    ...
    7: [
        ...
        img("日本にも、似た騒ぎ", 3, "classroom", "【学力パニック】試験を受ける生徒たちの教室", telop="PISA 読解力 2003年: 8位 → 14位"),
