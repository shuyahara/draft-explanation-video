...
CREDIT = {
    ...
    "flea": "Photo: V H / Pexels",
    "headphones": "Photo: Burst / Pexels",
    "queue": "Photo: zhang kaiyv / Pexels",
    "umbrellas": "Photo: Jan van der Wolf / Pexels",
    "notebook": "Photo: Artem Podrez / Pexels",
}
...
SOURCE_FILE = {
    ...
    "flea": "stock/s02_flea_app_2_pexels.jpg",
    "headphones": "stock/s04_headphones_2_pexels.jpg",
    "queue": "stock/s05_queue_3_pexels.jpg",
    "umbrellas": "stock/s06_umbrellas_1_pexels.jpg",
    "notebook": "stock/s07_notebook_2_pexels.jpg",
}
...
BEATS = {
    ...
    2: [
        ...
        img("メルカリで高値で転売されたの", 3, "flea", "【転売の実写】フリマアプリの画面を見る手元に替え、転売の事実を実写で見せる",
            source="LASISA（2026-05-22）"),
        img("6月、10代20代の女性に聞いた", 4, "flea", "【保持の分割】同じフリマアプリ写真を保持したまま、トレンド調査の出典をテロップで出す",
    ...
    6: [
        chapter(),
        img(None, 1, "umbrellas", "【冒頭】傘立てに並ぶ同じ色の傘（ストック）で開く"),
        ...
        img("隣の寮は、周りから", 6, "wristband", "【保持の分割】同じ写真を保持したまま20秒超を避けるための継続カット"),
    ...
    7: [
        chapter(),
        img(None, 1, "notebook", "【冒頭】赤ちゃんの名前を考える手元（ストック）で開く",
