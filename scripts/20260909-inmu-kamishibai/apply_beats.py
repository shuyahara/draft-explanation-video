...
S6 39秒）ため、前振り部分を image ビートへ譲って図解の保持を短縮した:
  ...
  S3 sketch 3行2列（Shifman 2012 の6特徴。行数上限3のため「特徴／当てはめ」を1セルに結合し
     6項目を2列3行に収める。台本 00-outline.md の代替案どおり。前振り「真似され続ける動画には」
     〜「真似されやすいということね」は selfie_video の image ビートへ）
...
PAUSE_OVERRIDES: dict[int, list[tuple[str, float]]] = {
    ...
    5: [("千九百六十八年に示したの", 0.45), ("ニコニコ動画だったのだ", 1.2)],
...
BEATS = {
    ...
    2: [
        ...
        img("二千一年に発売された", 2, "famous_face", "【出典の明示】黒線入り静止画を出所テロップ付きで提示",
        ...
        img("なぜこれだけが二十五年も生き残ったのか", 3, "app_feed", "【問いの再提示】動画アプリのサムネイル一覧をスクロールする手元に替え、なぜ生き残ったのかを問う（棚の絵の再掲は婉曲だったため差し替え）"),
        img("面白さだけでは、二十五年は続かないの", 4, "tiktok", "【決め文の保持】ダンス動画に戻し、決め文の間1.5秒まで保持"),
    ],
    3: [
        img(None, 1, "selfie_video", "【比喩の直接化】自宅で自撮り動画を撮る普通の人。真似される動画のイメージを直接描写（図解の保持74秒が長すぎたため前半をimageビートへ）"),
        img("この六つは", 2, "selfie_video", "【間】同じ絵のまま、シフマンの研究紹介へ尺を分ける（保持38秒を短縮するため分割）"),
        diagram(
            "淫夢の素材に当てはめてみましょう",
            "【6特徴】Shifman(2012)の6特徴と淫夢への当てはめを『特徴／当てはめ』の1セルにまとめ2列3行で（行数上限3のため。保持時間短縮のため前振りはimageビートへ譲る）",
            sketch(
                [
                    [
                        cell("f1", text="普通の人／素人出演者", at="素人に近い出演者", after="素人に近い出演者"),
                        cell("f2", text="男らしさ欠如／演技緩い", at="締まらない演技", after="締まらない演技"),
                    ],
                    [
                        cell("f3", text="単純／短い言い回し", at="短い言い回し", after="短い言い回し"),
                        cell("f4", text="繰り返し／繰り返せる場面", at="繰り返せる場面", after="繰り返せる場面"),
                    ],
                    [
                        cell("f5", text="奇妙／意味不明のやり取り", at="意味の分からないやり取り", after="意味の分からないやり取り"),
                        cell("f6", text="笑える／（空欄）", at="そこは空けておくわね", after="そこは空けておくわね"),
                    ],
                ],
                highlight={"ids": ["f1", "f2", "f3", "f4", "f5"], "at": "はっきり当てはまるわ", "after": "はっきり当てはまるわ"},
            ),
        ),
    ...
    4: [
        ...
        img(None, 1, "classroom", "【自分は分かる側】教室で一人だけ落書きに笑う生徒（記号のみ）",
            telop="社会的アイデンティティ理論"),
        img("イギリスのブリストル大学のタジフェルとターナーが", 2, "circle_outsider", "【出典の提示】輪の絵に替え、Tajfel & Turnerの提唱年を見せる"),
    ...
    7: [
        ...
        img("ビリー・ヘリントンというアメリカの俳優よ", 9, "fan_event_back", "【対比する実例】ヘリントンの後ろ姿でファンの歓待を描写（顔なし）"),
        img("彼は、それを知って、自分から受け入れたの", 10, "fan_event_back", "【間】同じ絵のまま、来日・追悼の話へ尺を分ける"),
        diagram(
            "同じ切り貼りなのに、片方は本人が選んで表に出て",
            "【ヘリントン対比】選択の有無と結果を見出し行＋2行の3行2列で対比し、決め文の間2.0秒まで保持",
            sketch(
                [
                    [
                        cell("h0", text="ビリー・ヘリントン", icon="person", at="同じ切り貼りなのに、片方は本人が選んで表に出て"),
                        cell("p0", text="淫夢の出演者", icon="person_off", at="同じ切り貼りなのに、片方は本人が選んで表に出て"),
                    ],
                    [
                        cell("h1", text="自分で選んで表に出た", at="自分で選んで表に出た", after="自分で選んで表に出た"),
                        cell("p1", text="選んでいない", at="選んでいないのに引き出されたの", after="選んでいないのに引き出された"),
                    ],
                    [
                        cell("h2", text="来日・イベント出演", at="同じ切り貼りなのに、片方は本人が選んで表に出て"),
                        cell("p2", text="探し出される", at="同じ切り貼りなのに、片方は本人が選んで表に出て"),
                    ],
                ],
                arrows=[("h1", "h2"), ("p1", "p2")],
                highlight={"ids": ["p1", "p2"], "at": "選んでいないのに引き出されたの", "after": "選んでいないのに引き出された"},
                caption={"text": "同じ切り貼り、違う経緯", "at": "同じ切り貼りなのに、片方は本人が選んで表に出て"},
            ),
        ),
    ],
    8: [
