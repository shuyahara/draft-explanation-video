...
BEATS = {
    ...
    6: [
        ...
        img("これで、ずんだもんの最初の疑問には答えが出たわ", 4, "nico_comments", "【問いへの回収】コメント可視化に戻り、最初の疑問への答えを示す"),
    ...
    7: [
        ...
        diagram(
            ...
            sketch(
                [
                    [
                        cell("h0", text="ビリー・ヘリントン", icon="person", at="同じようなミームなのに、片方は本人が"),
                        cell("p0", text="淫夢の出演者", icon="person_off", at="同じようなミームなのに、片方は本人が"),
                    ],
                    [
                    ...
                    [
                        cell("h2", text="来日・イベント出演", at="同じようなミームなのに、片方は本人が"),
                        cell("p2", text="探し出される", at="同じようなミームなのに、片方は本人が"),
                    ],
                ],
                arrows=[("h1", "h2"), ("p1", "p2")],
                highlight={"ids": ["p1", "p2"], "at": "自らの意思では表に出てきていないのに捜索されたりしている", "after": "自らの意思では表に出てきていないのに捜索されたりしている"},
                caption={"text": "同じ切り貼り、違う経緯", "at": "同じようなミームなのに、片方は本人が"},
            ),
        ),
    ],
    8: [
