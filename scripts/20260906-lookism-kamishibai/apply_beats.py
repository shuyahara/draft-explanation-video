...
BEATS = {
    ...
    6: [
        ...
        img("肩書きへの偏見を弱める", 5, "ringlight3", "【限定】カメラを構える後ろ姿に替えて「まず一人ひとりへの偏見」の限定へ"),
    ...
    7: [
        ...
        img("そう考える人が、以前より増えたのよ", 6, "crowd1", "【合いの手】サインの別カットに替えて「外野が責めるな」の一言へ"),
        img("本人の選択を尊重することと", 7, "interview2", "【留保】サインの別カットに替えて環境批判との両立の一言へ"),
