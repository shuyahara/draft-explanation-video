...
BEATS = {
    ...
    3: [
        ...
        img("私も、ずんだもんもね", 3, "phone1", "【日常への引き戻し】街の雑踏（再掲）で「誰でもやってしまう」を示す"),
    ...
    6: [
        ...
        img("そう考える人が増えると", 3, "bar3", "【推論①の帰結】鏡の別カットに替えて抵抗が弱まる、への接続"),
        img("もう一つは、ハロー効果よ", 4, "ringlight1", "【推論②の導入】リングライトの前で語る人（S1の再掲）",
            telop="推論②：ハロー効果→個人への偏見→仕事の見方も変わる"),
        board("そして写真SNSでは", "【推論②の筋】写真SNSでは見た目→人柄→肩書きの順に目に入る→ハロー効果が肩書きへの偏見を弱める、を黒板の文字で", telop="写真SNSでは 見た目 → 人柄 → 肩書き の順に目に入る\n→ ハロー効果が肩書きへの偏見を弱める"),
    ...
    7: [
        ...
        img("本人の選択を尊重することと", 7, "bar1", "【留保】サインの別カットに替えて環境批判との両立の一言へ"),
