...
BEATS = {
    ...
    3: [
        ...
        board("つまり私たちは、無意識に", "【覚えておくこと】美しい人は中身もきっと良い、と無意識に結びつける。章の要点を黒板の文字で", telop="覚えておくこと\n「美しい人は、中身もきっと良い」\n＝ 無意識に結びつけてしまう"),
    ...
    6: [
        ...
        board("そして写真SNSでは", "【推論②の筋】写真SNSでは見た目→人柄→肩書きの順に目に入る→ハロー効果が肩書きへの偏見を弱める、を黒板の文字で", telop="写真SNSで目に入る順番\n見た目 → 人柄 → 肩書き\n→ ハロー効果が肩書きへの偏見を弱める"),
