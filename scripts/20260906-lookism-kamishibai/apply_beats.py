...
CREDIT = {
    ...
    "lab1": "Photo: Pixabay",
    "feed3": "Photo: Brian Ramirez / Pexels",
    "fash1": "Photo: Marcus Aurelius / Pexels",
    "fash3": "Photo: Ron Lach / Pexels",
    "bar1": "Photo: Noel Aph / Pexels",
    "bar2": "Photo: Dmitriy Tarasenko / Pexels",
    "bar3": "Photo: cottonbro studio / Pexels",
    "judging3": "Photo: cottonbro studio / Pexels",
    "insta2": "Photo: cottonbro studio / Pexels",
    "insta3": "Photo: Kaboompics.com / Pexels",
...
SOURCE_FILE = {
    ...
    "lab1": "university-lab/university-lab-1.jpg",
    "feed3": "sns-people-feed/sns-people-feed-3.jpg",
    "fash1": "fashion-influencer/fashion-influencer-1.jpg",
    "fash3": "fashion-influencer/fashion-influencer-3.jpg",
    "bar1": "bar-counter/bar-counter-1.jpg",
    "bar2": "bar-counter/bar-counter-2.jpg",
    "bar3": "bar-counter/bar-counter-3.jpg",
    "judging3": "judging-eyes/judging-eyes-3.jpg",
    "insta2": "instagram-scroll/instagram-scroll-2.jpg",
    "insta3": "instagram-scroll/instagram-scroll-3.jpg",
...
GLOBAL_READINGS = [
    ("いい人", "イイヒト"),  # preflight 突合: 未登録だと「イイニン」「イイジン」
    ("日陰", "ヒカゲ"),
    ("多様性", "タヨウセイ"),
    ("偏り", "カタヨリ"),
    ("善い", "ヨイ"),
...
BEATS = {
    1: [
        ...
        img("ファッションのお手本", 5, "fash3", "【いま】ファッションの撮影を受ける人をスマホで撮る場面。お手本として語られる現在へ"),
        img("ねえ、ずんだもん", 6, "fash1", "【問い返し】服を並べてスマホで撮る手元に替えて「どうしてだと思う？」の間へ"),
        # 2026-09-07 試写3: 「時代が変わったから」の却下は主題ではないので板にしない（服を撮る手元を保持）。旧 img("それだと、何も言っていないのと同じよ", 7, "bookstore3", "【決め文】書店の別カットに替えて「時代が変わったから」のボツへ"),
        img("せっかくだから、心理学と経済学の研究を根拠にして", 8, "lab1", "【本題への導入】書店1カット目に戻し研究を根拠にする宣言へ"),
        board("調べていくとね", "【この動画で確かめること】外見の評価と、外見にかける手間やお金の見方の二つを黒板に", telop="この十数年で変わったこと\n① 私たちは外見をどう評価するか\n② 外見にお金や手間をかけることの見方"),
        # (旧) img("調べていくとね", 9, "bookstore2", "【予告】書店の別カットに替えて外見の評価・お金の話への予告へ"),
    ],
    2: [
        chapter(),
        img(None, 1, "dictionary1", "【定義の導入】「受け入れられている」の意味をそろえる。辞書を引く手元"),
        img("コメント欄", 2, "insta2", "【現実】きつい言葉も残るコメント欄の代替。PC の前で SNS を見る手元"),
        board("ここで言う「受け入れられている」には", "【定義】この動画で言う「受け入れられている」の二要素を黒板の文字で（主題の定義なので板で見せる）", telop="「受け入れられている」とは\n① 隠さず自分から話す人が増えた\n② 話した人が応援される場面が増えた\n　（昔の仕事だけを理由に責められない）"),
        img("さっきのユーチューバーは", 4, "phone1", "【当てはめ】スマホ画面操作の手元に替えてS1の例が二つとも当てはまる確認"),
        img("多様性の時代になったから", 5, "crowd2", "【よくある説明】「多様性の時代」の街の雑踏（後ろ姿）へ切り替え"),
        img("さっきよりはいい答えよ", 6, "crowd3", "【まだ足りない】雑踏の別カットに替えて「なぜ多様性が」の問い直しへ"),
        img("要因はいくつもあるけれど", 7, "crowd1", "【注目する変化】雑踏の別カットに替えて「大きいと考える変化」の予告へ"),
        img("それが、インスタグラムなどの", 9, "insta3", "【写真SNSの提示】インスタをスクロールする手元。ルッキズム加速の一文まで保持",
            telop="写真SNS → 外見が評価や収入につながりやすくなった"),
        board("ルッキズムって、見た目で人を判断すること", "【用語】ルッキズム＝見た目で人を判断・評価すること。定義を黒板の文字で", telop="ルッキズム\n＝ 見た目で人を判断・評価すること"),
        # (旧) img("ルッキズムって、見た目で人を判断すること", 8, "crowd2", "【疑問】雑踏1カット目に戻しルッキズムの語義への疑問へ"),
    ],
    3: [
        chapter(),
        board(None, "【用語】ハロー効果の定義を黒板の文字で（目立つ特徴→印象に引っぱられ→無関係な性格・能力まで同じ方向に評価）", telop="ハロー効果\n＝ 目立つ特徴が一つあると\n　その印象に引っぱられて\n　関係ない性格や能力まで同じ方向に評価する"),
        img("たとえば、どういうことなのだ", 2, "portrait3", "【ディオン1972の導入】写真箱の別カットに替えて出典の実験へ",
            telop="Dion et al. (1972) JPSP"),
        diagram(
            "男女60人の大学生に",
            ...
            sketch(
                [
                    [
                        ...
                        cell("res", "魅力が高いほど", icon="star", at="ところが答えは"),
                    ],
                    [
                        cell("w1", "温かい", icon="favorite", at="魅力が高い写真の人ほど", after="温かくて"),
                        cell("w2", "社交的", icon="groups", at="魅力が高い写真の人ほど", after="社交的で"),
                        cell("w3", "有能", icon="psychology", at="魅力が高い写真の人ほど", after="能力も高そうだ"),
                        cell("w4", "幸せ", icon="celebration", at="結婚も仕事もうまくいって", after="幸せな人生"),
                    ],
                ],
                arrows=[("subj", "op"), ("op", "res")],
            ),
        ),
        img("私も、ずんだもんもね", 3, "phone2", "【日常への引き戻し】街の雑踏（再掲）で「誰でもやってしまう」を示す"),
        board("つまり私たちは、無意識に", "【覚えておくこと】美しい人は中身もきっと良い、と無意識に結びつける。章の要点を黒板の文字で", telop="「美しい人は、中身もきっと良い」\n＝ 顔を見ただけで、無意識に結びつけてしまう"),
        # (旧) img("つまり私たちは、無意識に", 4, "crowd3", "【まとめ】雑踏の別カットに替えて結びつけの一言へ"),
        img("でも、それが世の中を変えるほど大きい力なのだ", 5, "paycheck2", "【次章への問い】雑踏の別カットに替えて賃金差への予告へ"),
    ],
    4: [
        chapter(),
        img(None, 1, "paycheck2", "【賃金差の導入】財布から紙幣を取り出す手元",
            telop="Hamermesh & Biddle (1994) AER"),
        ...
        board("学歴や経験など", "【用語】美の経済的プレミアム＝条件を考慮しても残る見た目による賃金差。黒板の文字で", telop="美の経済的プレミアム\n＝ 学歴や経験を考慮しても残る\n　見た目による賃金の差（＋5% ／ －7%）"),
        # (旧) img("学歴や経験など", 3, "interview2", "【美の経済的プレミアム】統計的に条件を考慮しても差が残る話へ。面接室（後ろ姿）"),
        img("見た目が生きる仕事を選んだから", 4, "interview1", "【sorting】握手の手元に替えて職業選択だけでは説明しきれない点へ"),
        img("キャバ嬢も、その一つなのだ", 5, "bar1", "【接続】握手の別カットに替えてキャバ嬢との関連づけへ"),
        img("でも、それは昔の話なのだ", 6, "insta2", "【加工が当たり前の今への疑問】PC の前で SNS を見る手元。写真が加工できると皆が知る時代でも写真で中身を決めるか、の問いへ"),
        img("美顔フィルターを使って", 7, "filter1", "【追試の導入】Gulati 2024 の美顔フィルター実験。自撮りする手元（顔はぼけて背景）",
            telop="Gulati ら 2024（ELLIS Alicante）"),
        diagram(
            "加工前と、フィルターをかけた後を",
    ...
    5: [
        chapter(),
        img(None, 1, "feed3", "【入口】写真中心のSNSを開いたときに最初に目に入るもの。人物の写真が並ぶインスタグラムの画面を持つ手元",
            telop="Di Gesto ら 2021 フィレンツェ大学"),
        diagram(
            "最初の判断材料になるのよ",
        ...
        img("医師への調査", 2, "clinic3", "【AAFPRS 会員調査】自撮りのために整形を望む患者増。美容クリニックの施術室（人物なし）",
            telop="AAFPRS 会員調査 2021：医師の77%"),
        img("2021年には、77パーセントの", 3, "mirror2", "【数字】鏡の前で身支度する後ろ姿に替えて「自撮りでよく見せるため」の 77% へ"),
        img("写真が先で、顔が後", 4, "insta3", "【決め文】「写真が先で、顔が後」。インスタをスクロールする手元で保持"),
        board("ここまでが、研究で分かっていることよ", "【区切り】研究で分かったこと／ここからは推論、を黒板の文字で", telop="ここまで：研究で分かっていること\n① 写真SNSは、見た目の評価を強めた\n② 見た目を変える行動まで広げた\nここから：研究を材料にした推論"),
        # (旧) img("ここまでが、研究で分かっていることよ", 5, "filter1", "【切り替え】自撮りする手元の別カットに替えて推論パートへの予告へ"),
    ],
    6: [
        img(None, 1, "mirror3", "【推論①の導入】鏡の前でネクタイを結ぶ後ろ姿",
            telop="推論①：美は手に入れてよい→見た目で働く人を責めにくい"),
        img("生まれつきの顔じゃなくて", 2, "clinic2", "【問い返し】鏡の別カットに替えて「美しさを手に入れてもいい」の確認へ"),
        img("そう考える人が増えると", 3, "mirror1", "【推論①の帰結】鏡の別カットに替えて抵抗が弱まる、への接続"),
        img("もう一つは、ハロー効果よ", 4, "ringlight1", "【推論②の導入】リングライトの前で語る人（S1の再掲）",
            telop="推論②：ハロー効果→個人への偏見→仕事の見方も変わる"),
        diagram(
            "そして写真SNSでは",
            "【推論②の筋: 図解】写真SNSでは 見た目→人柄→肩書き の順に目に入り、先の印象（ハロー効果）が肩書きへの偏見を弱める。順序と因果は板の文字ではなく矢印で見せる",
            sketch(
                [
                    [
                        cell("look", "見た目", icon="face", at="そして写真SNSでは"),
                        cell("person", "人柄", icon="favorite", at="そして写真SNSでは"),
                        cell("title", "肩書き", icon="badge", at="そして写真SNSでは"),
                    ],
                    [None, None, cell("res", "偏見が弱まる", icon="trending_down", at="肩書きへの偏見を弱める", after="弱める")],
                ],
                arrows=[("look", "person"), ("person", "title"), ("title", "res")],
                highlight={"ids": ["res"], "at": "肩書きへの偏見を弱める", "after": "弱める"},
                caption={"text": "先の印象が、あとの評価を引き上げる", "at": "肩書きへの偏見を弱める"},
            ),
        ),
        # (旧) img("肩書きへの偏見を弱める", 5, "ringlight3", "【限定】カメラを構える後ろ姿に替えて「まず一人ひとりへの偏見」の限定へ"),
    ...
    7: [
        img(None, 1, "streamer1", "【補強する変化①の導入】配信デスク（マイク・キーボード・画面）",
            telop="補強①：自分の名前で発信→一人の人として見られる"),
        img("さっきの元キャバ嬢の人も", 2, "ringlight2", "【当てはめ】無人のポッドキャストスタジオに替えてS1の当事者への接続"),
        img("そうなると、肩書きだけでなく", 3, "ringlight3", "【接続】ノートPCとマイクのデスクに替えて「肩書きより一人の人」への接続"),
        img("知り合いみたい", 4, "phone2", "【知り合いみたいという感覚】スマホ画面操作の手元（S1の再掲）"),
        img("自分で決めていい", 5, "mirror3", "【補強する変化②の導入】書類にサインする手元",
            telop="補強②：体と生き方は自分で決める（環境批判と両立）"),
        img("そう考える人が、以前より増えたのよ", 6, "judging3", "【合いの手】サインの別カットに替えて「外野が責めるな」の一言へ"),
        board("本人の選択を尊重することと", "【両立する二つ】本人の選択の尊重と、安全や搾取の問題の指摘は両立する、を黒板の文字で", telop="両立する二つ\n・本人の選択を尊重する\n・安全や搾取の問題を指摘する"),
        # (旧) img("本人の選択を尊重することと", 7, "bar1", "【留保】サインの別カットに替えて環境批判との両立の一言へ"),
        img("SNSは、外見と、その人の物語を", 8, "insta2", "【接続】最初のサインの手元に戻し二つの変化の結びつきへ"),
        img("でも、きれいすぎて", 9, "phone2", "【次章への問い】サインの別カットに替えて「穴はないのか」の疑いへ"),
    ],
    8: [
        chapter(),
        ...
        img("三つ目は", 3, "clinic3", "【反証③】整形容認と性産業容認は別問題。美容クリニック（再掲）",
            telop="反証③：整形の容認と性産業の容認は別の問題"),
        img("確かに、整形は自分の顔の話で", 4, "mirror1", "【留保】施術室の別カットに替えて「そこまでなら言える」への着地"),
    ...
    9: [
        ...
        img("はじく力の話なのだ", 1, "scale2", "【反証②への回帰】同じ力が選別の圧力にもなる。天秤",
            telop="同じ力は見た目で選別する圧力にもなる（採用・評価・SNS）"),
        img("同じルッキズムの力は", 2, "scale1", "【本題】天秤の別カットに替えて選別の圧力そのものの説明へ"),
        img("受け入れられた人の裏で", 3, "scale3", "【裏側】アンティークの天秤に替えて厳しく見られる人の存在へ"),
        img("安心しないことね", 4, "phone2", "【動画をもう一度見る】公園で動画を見る手元。冒頭の動画への回帰"),
        img("選ばれなかった人もいるのだ", 6, "crowd3", "【選ばれなかった人】画面に出てこない大勢の人。街の雑踏（後ろ姿）で示す"),
