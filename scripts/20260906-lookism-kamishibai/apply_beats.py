...
BEATS = {
    1: [
        ...
        board("それだと、何も言っていないのと同じよ", "【ボツの理由】「時代が変わったから」は何も説明していない、を黒板の文字で", telop="「時代が変わったから」\n＝ 何も説明していない"),
        # (旧) img("それだと、何も言っていないのと同じよ", 7, "bookstore3", "【決め文】書店の別カットに替えて「時代が変わったから」のボツへ"),
    ...
    2: [
        ...
        board("さっきよりはいい答えよ", "【問い直し】「多様性の時代」は答えの先送り。残る問いを黒板の文字で", telop="「多様性の時代になったから」\n→ なぜ多様性が認められるようになった？"),
        # (旧) img("さっきよりはいい答えよ", 6, "crowd3", "【まだ足りない】雑踏の別カットに替えて「なぜ多様性が」の問い直しへ"),
