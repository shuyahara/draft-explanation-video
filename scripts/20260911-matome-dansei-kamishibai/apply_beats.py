...
BEATS = {
    ...
    1: [
        ...
        img("先に、答えの形だけ", 7, "cafe_a", "【答えの形の予告】二人分のカップに戻し「嫌われてはいない／選ばれにくい」を予告"),
        img("嫌われてはいない", 8, "phone_b", "【間】手元に戻り、ずんだもんが違いを飲み込めないところまで尺を分ける"),
    ],
    # ---------------- S2 「まとも」の中身と、三つの段階 ----------------
    2: [
        ...
        img("そしてこれは、ずんだもん一人の話", 3, "commute_e", "【個人の話から数字へ】駅のホームに戻し、調査の数字へ移る"),
        img("18歳から34歳の未婚男性", 4, "commute_c",
            "【72.2%】交際相手がいない割合を数字と同時に出す",
            telop="交際相手なし 72.2%（18〜34歳 未婚男性）", source=IPSS),
        img("ここで、先に決めておきたい", 5, "office_b", "【段階分けの前置き】働く場面の別カットに替え、段階を分ける宣言へ"),
        ...
        board("モテる要素は、段階ごとに違うの",
              ...
              telop=stage_board()),
        img("でも、優しくしてるのに", 7, "commute_e", "【次章への問い】駅のホームに戻し、優しさが嫌われているのかという問いで閉じる"),
    ],
    ...
    3: [
        ...
        img("48人でも194人でも", 2, "university_b", "【再現性】大学の校舎に替え、二度の実験の人数を出す",
    ...
    4: [
        board(None, "【道しるべ】章カードは無いがここから段階が変わるので、冒頭に板を出す（②会ったあと）",
              telop=stage_board(2)),
        img("さっきの2021年の調査で", 1, "phone_c",
            "【会う前の言葉】夜のスマホの手元で、写真とプロフィールしか見えない段階の「言葉」を出す",
            telop="人柄を重視 88.2%／容姿 18.8%", source=IPSS + "・女性の回答"),
        img("それなら僕の人柄", 2, "cafe_c", "【会ったあとを測る】カフェのカットに替え、言葉の話から実験の話へ渡す"),
        img("2008年、ノースウェスタン大学", 3, "facetoface_a", "【実験へ】向かい合う男女の席に替え、スピードデートの実験に入る",
        ...
        img("そうなの", 6, "laughing_a", "【人当たりの良さ】笑いながら話す二人に替え、4分で効いたことと、その言葉の限定へ"),
    ...
    6: [
        ...
        img("手がかりを素早く読む仕組みは", 10, "phone_b", "【決め文の保持】夜のスマホの手元に替え、会う仕組みだけが新しいという決め文と間2.5秒を持たせる"),
