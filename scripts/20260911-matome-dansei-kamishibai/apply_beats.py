...
CREDIT = {
    "night_phone": "Photo: Jaroslav Maler / Pexels",
    ...
    "facetoface": "Photo: Mike Jones / Pexels",
...
SOURCE_FILE = {
    ...
    "facetoface": "stock/s04_facetoface_a.jpg",
...
BEATS = {
    ...
    3: [
        ...
        img("カナダのゲルフ大学", 6, "university", "【1999年の研究】ゲルフ大学の設問を紹介する",
    ...
    6: [
        ...
        img("人の魅力は、二つのものさしで", 2, "laughing",
            "【人に良くする力】笑い合う二人で、一本目のものさし（優しさ・誠実さ・思いやり）を直接描く"),
        img("もう一つは、自分から前に出る力", 3, "open_posture",
            "【自分から前に出る力】ゆったり座って話す人に替え、二本目のものさし（姿勢や発言で見せる）を直接描く"),
        img("そこが、いちばん勘違いされやすいところね", 4, "commute", "【反対ではない】通勤の絵に戻し、二つが別々のものさしである話を続ける"),
        img("だから「優しさを捨てて男らしくなれ」", 5, "laughing", "【誤解を断つ】笑い合う二人に替え、優しさを減らしても自信は上がらない話へ"),
        img("断っておくと、この二つで人の魅力が", 6, "laughing", "【範囲の限定】同じ絵のまま、二本で全部が説明できるわけではない旨まで尺を分ける"),
        diagram(
        ...
        img("だから、「まとも」だと言えるだけでは", 7, "commute", "【間】通勤の絵に戻し、伝わらないという受けまで尺を分ける"),
        img("その前に出る力が実際に効くことも", 8, "commute", "【姿勢の研究へ】バークレー校の研究の紹介に入る",
            source="Vacharkulksemsuk et al. (2016) PNAS 113(15)"),
        img("体を開いて、ゆったりした姿勢", 9, "open_posture", "【開いた姿勢】体を開いた姿勢の写真に戻り、1.76倍の結果を出す",
            telop="開いた姿勢 約1.76倍／アプリ 約1.27倍"),
        img("姿勢だけで！？", 10, "closed_posture", "【対比の1枚】比較対象の縮こまった姿勢に切り替える（同じ1枚に入れず image ビートを分ける指定。台詞の途中では切れないので、ずんだもんの驚きのキューで切り替えた）"),
        img("ただし、姿勢が伝えていたのが余裕だけ", 11, "open_posture", "【留保】開いた姿勢に戻し、姿勢が伝えていたものの限定と早合点へ"),
    ],
    # ---------------- S7 男らしさには、二種類ある ----------------
    7: [
    ...
    12: [
        ...
        img("返事をもらえた割合も見てみましょう", 3, "night_phone", "【返信率は逆】送っている数と返る割合が男女で逆であることを出す",
