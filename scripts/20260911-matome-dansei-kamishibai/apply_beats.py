...
BEATS = {
    ...
    5: [
        ...
        img("姿勢だけで", 5, "closed_a", "【対比の1枚】比較対象の縮こまった姿勢に切り替える（同一キュー内では切れないので、ずんだもんの驚きのキューで）"),
        img("聞いたことあるのだ", 6, "intimidate_c", "【悪い男の説】腕を組む人に替え、悪い男の方がモテるという説を受け止めて待ったをかける"),
        board("自信の見せ方には、二種類あるの",
              "【二種類の見せ方】威圧と尊敬の違いを黒板に書き、次の研究の結果を読む前提にする",
              telop=CONFIDENCE_BOARD),
        img("威圧するやり方に惹かれるのは", 7, "intimidate_a", "【短い関係だけ】腕を組む別カットに替え、威圧に惹かれるのは短期を探す人だけという結果へ",
    ...
    7: [
        ...
        img("初対面で決まってるわけじゃ", 4, "friends_walking_a", "【もう一つの研究へ】並んで歩く別カットに替え、次の研究に渡す"),
