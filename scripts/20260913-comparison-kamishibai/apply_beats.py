...
BEATS = {
    ...
    1: [
        ...
        img("仕事の出来みたいに目盛りのないものは", 5, "scale", "【目盛りのない例】体重計に乗る足元（S3用候補を流用）に替え、目盛りのない測り方の話に入る"),
    ...
    7: [
        ...
        img("眺めた組だけ", 4, "glow7", "【結果】同じ暗い部屋の写真を保持したまま、9%低下／変化なしをテロップで出す",
            telop="眺める組: 夜の気分 約9％低下／動く組: 変化なし"),
        img("そう、直後には出ないの", 5, "glow7", "【保持の分割】同じ暗い部屋の写真を保持したまま20秒超を避けるための継続カット"),
        img("1週間、1日5回ずつ", 6, "glow7", "【保持の分割】同じ暗い部屋の写真を保持したまま20秒超を避けるための継続カット（2）"),
        img("眺めた後の時間帯ほど", 7, "glow7", "【保持の分割】同じ暗い部屋の写真を保持したまま20秒超を避けるための継続カット（3）"),
        diagram(
            "眺めてから気分が下がるまでに",
    ...
    9: [
        ...
        board("三つ目。", "【板の進行3/3】③（比べる相手を自分で決める）を書き足して三つ揃える",
              telop="比べ方の使い直し\n① 見えない部分も数に入れる\n② 話しかける\n③ 比べる相手を自分で決める"),
        img("あまり社交的じゃない知人を", 2, "walk", "【相手を選ぶ例】友人数人の後ろ姿に替え、三つ目の使い直しの結果をテロップで出す",
            telop="比べる相手を変えると、『自分の方が劣っている』感覚が消えた",
            source="Deri, S., Davidai, S., & Gilovich, T. (2017). Study 6A. コーネル大学 154人"),
        img("この実験は社交生活の話だから", 3, "walk", "【保持の分割】同じ写真を保持したまま継続カット"),
        diagram(
            "銀と銅で、何を見たかによって",
        ...
        img("じゃあ、フィードに出てきた順に", 4, "walk", "【決め文の保持後】友人の後ろ姿の写真に戻し、シーン末まで保持"),
    ],
    # ---------------- S10 結び（冒頭の夜に戻る） ----------------
    10: [
